const toggleSecondaryNavbar = () => {
  ...
  readtime?.addEventListener('click', () => {
    ...
    if (interests && interests.classList.contains('text-info')) interests.classList.toggle ('text-info');
    if (readtime && readlists.classList.contains('text-info')) readlists.classList.toggle('text-info');
    if (dashboard && dashboard.classList.contains('text-info')) dashboard.classList.toggle('text-info');
  ...
  interests?.addEventListener('click', () => {
    ...
    if (readlists && readlists.classList.contains('text-info')) readlists.classList.toggle('text-info');
    if (dashboard && dashboard.classList.contains('text-info')) dashboard.classList.toggle('text-info');
